...
subject to contvsplus{s in S, i in rings} : tau*x[i]*diS[i,s]<=vs[i,s];
subject to contvsminus{s in S, i in rings} : -tau*x[i]*diS[i,s]<=vs[i,s];
subject to cont1pplus{p in P, i in rings} : tau*x[i]*diP[i,p]<=vp[i,p];
subject to contpminus{p in P, i in rings} : tau*x[i]*diP[i,p]<=vp[i,p];